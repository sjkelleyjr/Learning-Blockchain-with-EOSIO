...
describe("NodeosActionReader", () => {
    ...
    beforeAll(() => {
        request = {
            get: () => __awaiter(this, void 0, void 0, function* () { return blockInfo; }),
            post: () => __awaiter(this, void 0, void 0, function* () { return rawBlock; }),
        };
    });
    beforeEach(() => {
        reader = new NodeosActionReader_1.NodeosActionReader("", 1, false, 600, request);
    });
    it("returns last irreversible block if configured", () => __awaiter(this, void 0, void 0, function* () {
        reader = new NodeosActionReader_1.NodeosActionReader("", 1, true, 600, request);
        const blockNum = yield reader.getHeadBlockNumber();
        expect(blockNum).toBe(10);
    }));
    it("returns head block if configured", () => __awaiter(this, void 0, void 0, function* () {
        const blockNum = yield reader.getHeadBlockNumber();
        expect(blockNum).toBe(20);
    }));
    it("gets a block", () => __awaiter(this, void 0, void 0, function* () {
