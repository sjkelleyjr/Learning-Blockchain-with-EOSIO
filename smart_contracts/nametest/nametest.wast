(module
 ...
 (table 2 2 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN8nametest4testEy)
 (memory $0 1)
 (data (i32.const 4) "`a\00\00")
 (data (i32.const 16) "read\00")
 (data (i32.const 32) "Hello from \00")
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (block $label$0
   (block $label$1
    ...
    (drop
     (call $_ZN5eosio14execute_actionI8nametestS1_JyEEEbPT_MT0_FvDpT1_E
      (i32.add
       (get_local $3)
       (i32.const 24)
      )
 ...
 (func $_ZN8nametest4testEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (call $prints
   (i32.const 32)
  )
  (call $printn
 ...
 (func $_ZN5eosio14execute_actionI8nametestS1_JyEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
